...
func TestParseEnvConfig(t *testing.T) {
	...
	t.Setenv("ONLISHOP_CLI_ACCOUNT_EMAIL", testData.email)
	t.Setenv("ONLISHOP_CLI_ACCOUNT_PASSWORD", testData.password)
	t.Setenv("ONLISHOP_CLI_ACCOUNT_COMPANY", strconv.Itoa(testData.companyId))
...
func TestParseFileConfig(t *testing.T) {
	...
	testConfig := filepath.Join(cwd, "testdata/.onlishop-cli.yml")
