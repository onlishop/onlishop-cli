...
type ToolConfig struct {
	...
	// The minimum version of Onlishop that is supported
	MinOnlishopVersion string
	// The maximum version of Onlishop that is supported
	MaxOnlishopVersion string
	// The version of Onlishop that is checked against
	CheckAgainst string
