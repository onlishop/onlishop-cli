...
func TestComposerJsonRepositoriesHasRepository(t *testing.T) {
	repos := ComposerJsonRepositories{
		{
			Type: "vcs",
			URL:  "https://github.com/onlishop/platform",
		},
		{
			Type: "composer",
	...
	assert.True(t, repos.HasRepository("https://github.com/onlishop/platform"))
	assert.True(t, repos.HasRepository("https://packages.example.org"))
	assert.False(t, repos.HasRepository("https://github.com/onlishop/core"))
...
func TestReadComposerJson(t *testing.T) {
	...
	t.Run("valid file", func(t *testing.T) {
		...
		assert.Equal(t, "onlishop/cli", composer.Name)
		assert.Equal(t, "Onlishop CLI tool", composer.Description)
		...
		assert.Equal(t, "https://github.com/onlishop/platform", composer.Repositories[0].URL)
	})
...
`
		...
		expectedRepos := []ComposerJsonRepository{
			{Type: "vcs", URL: "https://github.com/onlishop/platform"},
