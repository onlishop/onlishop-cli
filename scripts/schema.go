...
func generateProjectSchema() error {
	...
	if err := r.AddGoComments("github.com/onlishop/onlishop-cli", "./shop"); err != nil {
		return err
	}
	...
	if err := os.WriteFile("shop/onlishop-project-schema.json", bytes, 0o644); err != nil {
		return err
	}
...
func generateExtensionSchema() error {
	...
	if err := r.AddGoComments("github.com/onlishop/onlishop-cli", "./extension"); err != nil {
		return err
	}

	if err := r.AddGoComments("github.com/onlishop/onlishop-cli", "./internal/changelog"); err != nil {
		return err
	}
	...
	if err := os.WriteFile("extension/onlishop-extension-schema.json", bytes, 0o644); err != nil {
		return err
	}
