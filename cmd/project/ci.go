...
import (
	...
	"github.com/onlishop/onlishop-cli/internal/mjml"
	"github.com/onlishop/onlishop-cli/internal/packagist"
	"github.com/onlishop/onlishop-cli/internal/phpexec"
...
var cleanupPaths = []string{
	"vendor/onlishop/storefront/Resources/app/storefront/vendor/bootstrap/dist",
	"vendor/onlishop/storefront/Resources/app/storefront/test",
	"vendor/onlishop/storefront/Test",
	"vendor/onlishop/core/Framework/Test",
	"vendor/onlishop/core/Content/Test",
	"vendor/onlishop/core/Checkout/Test",
	"vendor/onlishop/core/System/Test",
	"vendor/tecnickcom/tcpdf/examples",
}

var projectCI = &cobra.Command{
	Use:   "ci",
	Short: "Build Onlishop in the CI",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_ = os.Setenv("ONLISHOP_SKIP_ASSET_INSTALL_CACHE_INVALIDATION", "1")
		...
		assetCfg := extension.AssetBuildConfig{
			...
			OnlishopRoot:                 args[0],
			OnlishopVersion:              onlishopConstraint,
		...
		if err := cleanupAdministrationFiles(cmd.Context(), path.Join(args[0], "vendor", "onlishop", "administration")); err != nil {
			return err
		}

		if err := createEmptySnippetFolder(path.Join(args[0], "vendor", "onlishop", "administration")); err != nil {
			return err
		}
		...
		if !shopCfg.Build.KeepSourceMaps {
			if err := cleanupJavaScriptSourceMaps(path.Join(args[0], "vendor", "onlishop", "administration", "Resources", "public")); err != nil {
				return err
			}
		...
		if shopCfg.Build.RemoveExtensionAssets {
			...
			if err := os.RemoveAll(path.Join(args[0], "vendor", "onlishop", "administration", "Resources", "public")); err != nil {
				return err
			}

			if err := os.WriteFile(path.Join(args[0], "vendor", "onlishop", "administration", "Resources", ".administration-js"), []byte{}, os.ModePerm); err != nil {
				return err
			}

			if err := os.WriteFile(path.Join(args[0], "vendor", "onlishop", "administration", "Resources", ".administration-css"), []byte{}, os.ModePerm); err != nil {
				return err
			}
