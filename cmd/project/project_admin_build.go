...
var projectAdminBuildCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		} else if projectRoot, err = findClosestOnlishopProject(); err != nil {
			return err
		}
		...
		onlishopConstraint, err := extension.GetOnlishopProjectConstraint(projectRoot)
		if err != nil {
			return err
		}
