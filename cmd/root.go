...
import (
	...
	"github.com/onlishop/onlishop-cli/cmd/account"
	"github.com/onlishop/onlishop-cli/cmd/extension"
	"github.com/onlishop/onlishop-cli/cmd/project"
	accountApi "github.com/onlishop/onlishop-cli/internal/account-api"
...
var rootCmd = &cobra.Command{
	Use:     "onlishop-cli",
	Short:   "A cli for common Onlishop tasks",
...
func Execute(ctx context.Context) {
	...
	accountApi.SetUserAgent("onlishop-cli/" + version)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.onlishop-cli.yaml)")
