...
<manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/onlishop/onlishop/trunk/src/Core/Framework/App/Manifest/Schema/manifest-2.0.xsd">
	<meta>
...
func TestNoCompatibilityGiven(t *testing.T) {
	...
	compatibility, err := app.GetOnlishopVersionConstraint()
	assert.NoError(t, err)
