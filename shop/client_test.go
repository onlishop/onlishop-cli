...
func Test_newShopCredentials_envIntegration(t *testing.T) {
	t.Setenv("ONLISHOP_CLI_API_CLIENT_ID", "id")
	t.Setenv("ONLISHOP_CLI_API_CLIENT_SECRET", "secret")
...
func Test_newShopCredentials_envPassword(t *testing.T) {
	t.Setenv("ONLISHOP_CLI_API_USERNAME", "user")
	t.Setenv("ONLISHOP_CLI_API_PASSWORD", "pass")
...
func Test_newShopCredentials_configPassword(t *testing.T) {
	...
	t.Setenv("ONLISHOP_CLI_API_CLIENT_ID", "")
	t.Setenv("ONLISHOP_CLI_API_CLIENT_SECRET", "")
	t.Setenv("ONLISHOP_CLI_API_USERNAME", "")
	t.Setenv("ONLISHOP_CLI_API_PASSWORD", "")
...
func Test_NewShopClient(t *testing.T) {
	...
	t.Setenv("ONLISHOP_CLI_API_URL", server.URL)
	t.Setenv("ONLISHOP_CLI_API_CLIENT_ID", "id")
	t.Setenv("ONLISHOP_CLI_API_CLIENT_SECRET", "secret")
...
func Test_NewShopClient_skipSSLCheck_env(t *testing.T) {
	...
	t.Setenv("ONLISHOP_CLI_API_CLIENT_ID", "id")
	t.Setenv("ONLISHOP_CLI_API_CLIENT_SECRET", "secret")
	t.Setenv("ONLISHOP_CLI_API_DISABLE_SSL_CHECK", "true")
...
func Test_NewShopClient_skipSSLCheck_config(t *testing.T) {
	...
	t.Setenv("ONLISHOP_CLI_API_DISABLE_SSL_CHECK", "false")
